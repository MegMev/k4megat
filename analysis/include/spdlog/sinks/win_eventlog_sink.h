      ...
      namespace internal {
        ...
        struct win32_error : public spdlog_ex {
          ...
          static std::string format( std::string const& user_message, DWORD error_code = GetLastError() ) {
            ...
            auto          format_message_succeeded = ::FormatMessageA(
                         ...
                         error_code, MAKELANGID( LANG_NEUTRAL, SUBLANG_DEFAULT ), (LPSTR)&format_message_result.hlocal_, 0,
                         nullptr );
        ...
        public:
          ...
          static sid_t duplicate_sid( PSID psid ) {
            ...
            if ( !::CopySid( sid_length, (PSID)result.as_sid(), psid ) ) { SPDLOG_THROW( win32_error( "CopySid" ) ); }
