...
namespace megat {
  ...
  /** @class megat::sim::EventInformation SimKernel/SimKernel/EventInformation.h EventInformation.h
   *
  ...
  namespace sim {
    ...
    public:
       ...
       * @param[in] aMCParticleCollection  pointer to a collection that should take ownership of the particles saved
       * here
       */
