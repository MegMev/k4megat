...
/** @class RunManager SimKernel/SimKernel/RunManager.h RunManager.h
 *
...
namespace megat {
  ...
  namespace sim {
    ...
    public:
      ...
      /** Retrieves an event.
       *  It allows to retrieve the event containing the data that may be stored (eg. collections of hits in the
       * sensitive detectors). The lifetime of the pointer to G4Event ends when method terminateEvent() is called.
