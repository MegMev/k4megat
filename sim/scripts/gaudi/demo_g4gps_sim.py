...
from Configurables import SimG4GpsGenerator
gps = SimG4GpsGenerator('gpsSource')
gps.MacroFile = 'gps5.mac'
#gps.OutputLevel = DEBUG
...
outAlg = PodioOutput()
outAlg.filename = 'demo_g4gps_sim.root'
