...
/** @class ISimMagneticFieldTool SimInterface/SimInterface/ISimMagneticFieldTool.h ISimMagneticFieldTool.h
 *
...
class ISimMagneticFieldTool : virtual public IAlgTool {
public:
  DeclareInterfaceID(ISimMagneticFieldTool, 1, 0);
