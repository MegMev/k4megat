...
/** @class ISimParticleSmearTool SimInterface/SimInterface/ISimParticleSmearTool.h ISimParticleSmearTool.h
 *
...
class ISimParticleSmearTool : virtual public IAlgTool {
public:
  DeclareInterfaceID(ISimParticleSmearTool, 1, 0);
