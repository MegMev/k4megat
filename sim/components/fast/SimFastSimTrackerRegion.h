...
namespace megat {
  ...
  /** @class SimFastSimTrackerRegion SimFast/src/components/SimFastSimTrackerRegion.h SimFastSimTrackerRegion.h
   *
  ...
  class SimFastSimTrackerRegion : public GaudiTool, virtual public ISimRegionTool {
  public:
    explicit SimFastSimTrackerRegion( const std::string& type, const std::string& name, const IInterface* parent );
    virtual ~SimFastSimTrackerRegion();
    /**  Initialize.
     *   @return status code
     */
  ...
  private:
    ...
    ToolHandle<ISimParticleSmearTool> m_smearTool{ "SimParticleSmearSimple", this, true };
    ...
    Gaudi::Property<std::vector<std::string>> m_volumeNames{
        this, "volumeNames", {}, "Names of the parametrised volumes" };
