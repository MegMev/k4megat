...
DECLARE_COMPONENT(SimParticleSmearRootFile)
...
StatusCode SimParticleSmearRootFile::checkConditions(double aMinMomentum, double aMaxMomentum, double aMaxEta) const {
