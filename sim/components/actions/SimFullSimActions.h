...
namespace megat {
  ...
  private:
    ...
    Gaudi::Property<bool>   m_enableHistory{ this, "enableHistory", false,
                                           "Set to true to save secondary particle info" };
    Gaudi::Property<double> m_energyCut{ this, "energyCut", 0.0, "[MeV] minimum energy for secondaries to be saved" };
  };
