...
DECLARE_COMPONENT(SimConstantMagneticFieldTool)
...
G4MagIntegratorStepper* SimConstantMagneticFieldTool::stepper(const std::string& name, G4MagneticField* field) const {
