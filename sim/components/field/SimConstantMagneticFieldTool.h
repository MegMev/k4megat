...
namespace megat {
  ...
  /** @class SimConstantMagneticFieldTool SimComponents/src/SimConstantMagneticFieldTool.h
   * SimConstantMagneticFieldTool.h
   *
   *  Implementation of ISimMagneticFieldTool that generates a constant field
   *
   *  @author Andrea Dell'Acqua
   *  @date   2016-02-22
   */

  class SimConstantMagneticFieldTool : public GaudiTool, virtual public ISimMagneticFieldTool {
  public:
    /// Standard constructor
    SimConstantMagneticFieldTool( const std::string& type, const std::string& name, const IInterface* parent );

    /// Destructor
    virtual ~SimConstantMagneticFieldTool();
  ...
  private:
    ...
    /// This parameter governs accuracy of volume intersection, see G4 doc for more details. Set with property
    /// DeltaChord
    ...
    Gaudi::Property<double> m_maxStep{ this, "MaximumStep", 1. * m,
    ...
    Gaudi::Property<std::string> m_integratorStepper{ this, "IntegratorStepper", "NystromRK4",
