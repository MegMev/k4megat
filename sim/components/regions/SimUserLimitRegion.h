...
/** @class SimUserLimitRegion SimFull/src/components/SimUserLimitRegion.h SimUserLimitRegion.h
 *
 *  Tool for creating regions with user limits.
 *  It requires SimUserLimitPhysics to be used.
 *
 *  @author Anna Zaborowska
*/

class SimUserLimitRegion : public GaudiTool, virtual public ISimRegionTool {
public:
  explicit SimUserLimitRegion(const std::string& type, const std::string& name, const IInterface* parent);
  virtual ~SimUserLimitRegion();
  /**  Initialize.
   *   @return status code
   */
