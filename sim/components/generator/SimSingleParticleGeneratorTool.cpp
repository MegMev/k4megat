// local
#include "SimSingleParticleGeneratorTool.h"
...
DECLARE_COMPONENT(SimSingleParticleGeneratorTool)

SimSingleParticleGeneratorTool::SimSingleParticleGeneratorTool(const std::string& type,
...
SimSingleParticleGeneratorTool::~SimSingleParticleGeneratorTool() {}

StatusCode SimSingleParticleGeneratorTool::initialize() {
...
G4Event* SimSingleParticleGeneratorTool::g4Event() {
...
StatusCode SimSingleParticleGeneratorTool::saveToEdm(const G4PrimaryVertex* aVertex,
