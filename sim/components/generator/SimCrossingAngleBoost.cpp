#include "SimCrossingAngleBoost.h"
...
DECLARE_COMPONENT(SimCrossingAngleBoost)


SimCrossingAngleBoost::SimCrossingAngleBoost(
...
StatusCode SimCrossingAngleBoost::initialize() {
  StatusCode sc;
...
StatusCode SimCrossingAngleBoost::execute() {
...
StatusCode SimCrossingAngleBoost::finalize() {
