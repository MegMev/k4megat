...
namespace megat {
   ...
   *  E.g. '\b merge = [2,3,2]' means that first 2 volumes are merged into new cell (id=0), next 3 volumes become new
   * cell (id=1), and finally last 2 layers are merged into last cell (id=2). The sum of all sizes from the list should
   * correspond to the total number of volumes named as indicated in '\b volumeName'. For an example see
   * Detector/DetComponents/tests/options/mergeLayers.py
   *
